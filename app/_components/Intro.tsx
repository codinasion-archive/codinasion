...
export default function Intro() {
  return (
    <div className="container min-h-[90vh] mx-auto flex flex-col items-center justify-center">
      <h1 className="text-[10rem] leading-[9rem] tracking-wider text-center dark:text-white font-extrabold">
        CODINASION
      </h1>
      <p className="max-w-4xl text-center text-xl text-black/50 dark:text-white/50">
